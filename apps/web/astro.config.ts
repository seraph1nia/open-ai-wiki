...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      // "What's new" is pinned ahead of the corpus: it is the page a reader
      // coming back to the wiki wants first, and it is not part of the
      // autogenerated tree because it lives in `src/pages/` rather than the
      // bundle. Starlight prepends `base` to `link` itself, and the trailing
      // slash `trailingSlash: "always"` requires is already there, so the
      // route middleware has nothing to correct here.
      sidebar: [
        { label: "What's new", link: "/whats-new/" },
        { autogenerate: { directory: WIKI_ROOT } },
      ],
      social: [
        {
          icon: "rss",
