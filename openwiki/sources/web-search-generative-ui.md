...
This page records the 2026-08-16 web-search ingestion for the `web-search-generative-ui` source instance (two pulls the same day) and grounds the wiki's generative-UI protocol and framework pages. It is an evidence index, not the synthesis layer (see [Generative-UI ecosystem](/concepts/generative-ui-ecosystem.md)).
...
- New: [AG-UI](/protocols/ag-ui.md) (Java/Go SDKs), [A2UI](/protocols/a2ui.md) (data flow, renderers), [MCP Apps](/protocols/mcp-apps.md) (capability negotiation, SDK surface), [OpenUI](/frameworks/openui.md) (v0.5 language, Cloud), [CopilotKit](/frameworks/copilotkit.md) (HITL renderers, skills), [Mastra agentic-UI](/frameworks/mastra-agentic-ui.md) (UI dojo), [Generative-UI ecosystem](/concepts/generative-ui-ecosystem.md) hub.
...
- **watchlist:** open SDK/feature issues (Oracle Open Agent Spec, governance dashboard, CopilotKit #2840, csharp-sdk, java-sdk), third-party adoption claims, and package version numbers not cross-checked against release resources.
